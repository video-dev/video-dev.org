  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A community for video engineers with a focus on open source"
        />
      ...
      <footer className={styles.footer}>
        <section className={styles.links}>
          <a href="https://github.com/video-dev">
            <Image src="/github-mark.svg" width={35} height={35} alt="Github" />
          </a>
          <a href="https://demuxed.com">
            <Image
              src="/demuxed-mark.svg"
              width={35}
              height={35}
              alt="Demuxed"
            />
